<template>
    <div class="category-page gap-14">
        <h1 class="page__title uppercase text-white text-center text-2xl md:text-5xl font-bold bg-black pt-32 pb-10 w-full">{{ title }}</h1>
